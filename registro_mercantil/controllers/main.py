...
# from openerp.addons.web.controllers.main import Binary,  module_boot
...
#         html = request.registry.get('ir.ui.view').render(cr, session.uid,'registro_mercantil.TiffEditWidget',{
#             'init': init,
#             'modules': modules,
#         })
...
#     @http.route('/registro_mercantil/web_separator', type='http', auth='user')
#     def a_s(self, **k):
#         cr, uid, context, session = request.cr, request.uid, request.context, request.session
#         print str(k) + "---------------------------------------------------------------------------------------------------------------------\
#         ---------------------------------------------------------------------------------------------------------------"
...
#         html = request.registry.get('ir.ui.view').render(cr, session.uid,'registro_mercantil.TiffSeparator',{
#          #   'init': init,
#             'modules': modules,
#         })
...
#     @http.route('/registro_mercantil/BinaryTiff/tiff', type='http', auth="public")
