...
class rbs_tramite_propiedad(models.Model):
    ...
    tipo_libro_propiedad_ids = fields.Many2many(
        comodel_name='rbs.tipo.libro.propiedad',
        relation='rbs_tipo_libro_tramite_propiedad_rel',
        column1='tramite_id',
        column2='tipo_libro_id',
        string='Tipos de Libros Permitidos')
...
class rbs_tipo_libro_propiedad(models.Model):
    ...
    tramite_propiedad_ids = fields.Many2many(
        comodel_name='rbs.tramite.propiedad',
        relation='rbs_tipo_libro_tramite_propiedad_rel',
        column1='tipo_libro_id',
        column2='tramite_id',
        string='Tramites Permitidos')
...
class rbs_tramite_mercantil(models.Model):
    ...
    tipo_libro_mercantil_ids = fields.Many2many(
        comodel_name='rbs.tipo.libro.mercantil',
        relation='rbs_tipo_libro_tramite_mercantil_rel',
        column1='tramite_id',
        column2='tipo_libro_id',
        string='Tipos de Libros Permitidos')
...
class rbs_tipo_libro_mercantil(models.Model):
    ...
    tramite_mercantil_ids = fields.Many2many(
        comodel_name='rbs.tramite.mercantil',
        relation='rbs_tipo_libro_tramite_mercantil_rel',
        column1='tipo_libro_id',
        column2='tramite_id',
        string='Tramites Permitidos')
