odoo.define('registro_mercantil.archivo', function (require) {
"use strict";
...
//     var FieldBinaryTiff = core.form_widget_registry.get("binary").extend({
...
var FieldUrlTiff = widget.FieldChar.extend({
    ...
    core.form_widget_registry.add('FieldUrlTiff', FieldUrlTiff);
