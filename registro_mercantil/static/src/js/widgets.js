function openerp_tiff_widgets(instance, module){ //module is instance.point_of_sale
...
// ---------- Main Point of Sale Widget ----------
    ...
    module.TiffWidget = module.PosBaseWidget.extend({
        template: 'TiffWidget',
        init: function() { 
            this._super(arguments[0],{});

            this.pos = new module.TiffModel(this.session,{pos_widget:this});
