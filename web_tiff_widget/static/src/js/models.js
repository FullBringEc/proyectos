function openerp_tiff_models(instance, module){ //module is instance.point_of_sale
    ...
    module.TiffModel = Backbone.Model.extend({
        ...
        },
        {
            ...
            //ids:    function(self){ return [self.session.uid]; },
            domain: null,
            loaded: function(self,propiedad){
